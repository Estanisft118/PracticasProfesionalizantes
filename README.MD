...
- Paso 2: posicionarse en la ruta: /PracticasProfesionalizantes/backend.
- Paso 3: ejecutar en consola el comando: npm run dev.
- Paso 4: desde el archivo index.html levantar LiveServer (local).
---
