...
const contable={
	...
	"Derecho Laboral":[],
	"Derecho Comercial":[],
	"Tecnologìas y Sistemas para la Administraciòn":[],
	"Costos y Planificaciòn":[],
	"Ingles II":[],
	"Prácticas Profesionalizantes II: Diseño de Proyectos de Administraciòn":[],
	"Administraciòn Financiera":[],
	"Tècnica Impositiva y Laboral":[],
	"Règimen Tributario":[],
	"Administraciòn Estratègica":[],
	"Gestiòn de Estados Contables":[],
	"Finanzas de Empresas":[],
	"Prácticas Profesionalizantes III: Gestiòn e Implementaciòn de Proyectos de Administraciòn":[]
}